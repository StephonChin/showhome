  ...
  34                     ; 19 @far @interrupt void NonHandledInterrupt (void)
  34                     ; 20 {
  35                     	switch	.text
  ...
  80  0020 82            	dc.b	130
  82  0021 00            	dc.b	page(f_Zero_Detect_Interrupt)
  83  0022 0000          	dc.w	f_Zero_Detect_Interrupt
  84  0024 82            	dc.b	130
 ...
 130  0051 00            	dc.b	page(f_Uart_Rcv_Interrupt)
 131  0052 0000          	dc.w	f_Uart_Rcv_Interrupt
 ...
 150  0065 00            	dc.b	page(f_Tim4_Update_Interrupt)
 151  0066 0000          	dc.w	f_Tim4_Update_Interrupt
 ...
 229                     	xref	f_Zero_Detect_Interrupt
 230                     	xref	f_Tim4_Update_Interrupt
 231                     	xref	f_Uart_Rcv_Interrupt
 250                     	end
