...
_main:
.stabs "mainStep:9",128,0,0,_main_data@0
.stabn 0xC0,0,0,L12-_main
L12:
.stabn 0x44,0,10,L13-_main
L13:
;Line#10 {

 .stabn 0x44,0,11,L14-_main
L14:
;Line#11 	u8t mainStep = 0;

 	;MOVU1 _main_data@0 ,#0
	__SelectBANK _main_data@0
	CLR _main_data@0
.stabn 0x44,0,13,L15-_main
L15:
;Line#13 	McuConfig();
	...
	CALL _McuConfig
L3:
.stabn 0xC0,0,1,L16-_main
L16:
.stabn 0x44,0,16,L17-_main
L17:
;Line#16 	{

 .stabn 0x44,0,17,L18-_main
L18:
;Line#17 		if (FTC0IRQ)
	...
	B0BTS1 0xC8.5
	JMP L6
.stabn 0xC0,0,2,L19-_main
L19:
.stabn 0x44,0,18,L20-_main
L20:
;Line#18 		{

 .stabn 0x44,0,19,L21-_main
L21:
;Line#19 			FTC0IRQ = 0;

 	;MOVX1 0xC8.5 ,#0
	B0BCLR 0xC8.5
.stabn 0x44,0,20,L22-_main
L22:
;Line#20 			switch (mainStep)

 	;EQ L10 ,_main_data@0 ,#0
	__SelectBANK _main_data@0
	MOV A, _main_data@0
	JEQ L10
	;EQ L11 ,_main_data@0 ,#1
	SUB A, #0x01
	JEQ L11
	JMP L8
.stabn 0xC0,0,3,L23-_main
L23:
.stabn 0x44,0,21,L24-_main
L24:
;Line#21 			{

L10:
.stabn 0x44,0,23,L25-_main
L25:
;Line#23 					ProcessKey();

 	;CALLV _ProcessKey
	CALL _ProcessKey
.stabn 0x44,0,24,L26-_main
L26:
;Line#24 					mainStep++;

 	;ADDU1 _main_data@0 ,_main_data@0 ,#1
	__SelectBANK _main_data@0
	INCMS _main_data@0
	NOP
.stabn 0x44,0,25,L27-_main
L27:
;Line#25 					break;

	JMP L9
L11:
.stabn 0x44,0,27,L28-_main
L28:
;Line#27 					ProcessCom();

 	;CALLV _ProcessCom
	CALL _ProcessCom
.stabn 0x44,0,28,L29-_main
L29:
;Line#28 					mainStep = 0;
...
L9:
.stabn 0x44,0,35,L35-_main
L35:
;Line#35 			SleepMode();

 	;CALLV _SleepMode
	CALL _SleepMode
.stabn 0xE0,0,2,L36-_main
L36:
...
L4:
.stabn 0x44,0,15,L40-_main
L40:
;Line#15 	while(1)

	JMP L3
.stabn 0xE0,0,0,L41-_main
L41:
.stabn 0x44,0,38,L42-_main
L42:
;Line#38 }
L2:
_main_end:
...
CALLTREE _main invoke _McuConfig,_ProcessKey,_ProcessCom,_SleepMode
...
EXTERN CODE _ProcessCom
EXTERN CODE _ProcessKey
EXTERN CODE _SleepMode
