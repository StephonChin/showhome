...
_GpioInit:
.stabn 0xC0,0,0,L3-_GpioInit
L3:
.stabn 0x44,0,11,L4-_GpioInit
L4:
;Line#11 {

 .stabn 0x44,0,12,L5-_GpioInit
L5:
;Line#12 	  FP00M = 0;

 	;MOVX1 0xB8.0 ,#0
	B0BCLR 0xB8.0
.stabn 0x44,0,13,L6-_GpioInit
L6:
;Line#13 	  P0UR = 0;//////////////
...
;Line#18 	  P1W=0x01;
	...
	MOV A, #0x01
	B0MOV 0xC0, A
.stabn 0x44,0,20,L11-_GpioInit
L11:
;Line#20 	  FP12M = 1;

 	;MOVX1 0xC1.2 ,#1
	B0BSET 0xC1.2
.stabn 0x44,0,21,L12-_GpioInit
L12:
;Line#21 	  FP13M = 1;

 	;MOVX1 0xC1.3 ,#1
	B0BSET 0xC1.3
.stabn 0x44,0,22,L13-_GpioInit
L13:
;Line#22 	  FP12 = 0;

 	;MOVX1 0xD1.2 ,#0
	B0BCLR 0xD1.2
.stabn 0x44,0,23,L14-_GpioInit
L14:
;Line#23 	  FP13 = 0;

 	;MOVX1 0xD1.3 ,#0
	B0BCLR 0xD1.3
.stabn 0x44,0,25,L15-_GpioInit
L15:
;Line#25 	  P2M=0xff;
...
;Line#29 	  P5=0x10;
	...
	MOV A, #0x10
	B0MOV 0xD5, A
.stabn 0xE0,0,0,L19-_GpioInit
L19:
.stabn 0x44,0,30,L20-_GpioInit
L20:
;Line#30 }
...
_TimerInit:
.stabn 0xC0,0,0,L22-_TimerInit
L22:
.stabn 0x44,0,40,L23-_TimerInit
L23:
;Line#40 {

 .stabn 0x44,0,41,L24-_TimerInit
L24:
;Line#41 	  TC0R=206;     //(256-206)*2us=100us

 	;MOVU1 0xCD ,#206
	MOV A, #0xce
	B0MOV 0xCD, A
.stabn 0x44,0,42,L25-_TimerInit
L25:
;Line#42 	  TC0C=206;

 	;MOVU1 0xDB ,#206
	B0MOV 0xDB, A
.stabn 0x44,0,43,L26-_TimerInit
L26:
;Line#43 	  TC0M=0xf4; 
...
L27:
.stabn 0x44,0,44,L28-_TimerInit
L28:
;Line#44 }
...
L30:
.stabn 0x44,0,50,L31-_McuConfig
L31:
;Line#50 {

 .stabn 0x44,0,51,L32-_McuConfig
L32:
;Line#51 	GpioInit();

 	;CALLV _GpioInit
	CALL _GpioInit
.stabn 0x44,0,52,L33-_McuConfig
L33:
;Line#52 	TimerInit();
...
L34:
.stabn 0x44,0,53,L35-_McuConfig
L35:
;Line#53 }
L29:
	RET
