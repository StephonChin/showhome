...
.stabs "F:\PROJECT\ShowHome\ZW-1104\ZW1104(Flood Sensor)&ZW1105 - 8脚控制IC--2501D/",0x64,0,3,Ltext0
.stabs ".\Src\power_save.c",0x64,0,3,Ltext0
Ltext0:
...
PUBLIC _power_save
PUBLIC _power_save_enable

_power_save_c_GlobalBitDataPool0 BITSEGMENT DATA BANK 0 INBANK
	_power_save_enable DSBIT 1

_Function_power_save_data SEGMENT DATA INBANK
...
_sdata3@segment SEGMENT DATA INBANK
	_sdata3 DS 1
.stabs "power_save:F13",36,0,0,_power_save
_Function_power_save_code SEGMENT CODE INBANK USING _Function_power_save_data
_power_save:
.stabn 0xC0,0,0,L10-_power_save
L10:
.stabn 0x44,0,11,L11-_power_save
L11:
;Line#11 {

 .stabn 0x44,0,15,L12-_power_save
L12:
;Line#15   if(power_save_enable)

 	;EQ L4 ,_power_save_enable ,#0
	__SelectBANK _power_save_enable
	BTS1 _power_save_enable
	JMP L4
.stabn 0xC0,0,1,L13-_power_save
L13:
.stabn 0x44,0,16,L14-_power_save
L14:
;Line#16   {

 .stabn 0x44,0,17,L15-_power_save
L15:
;Line#17     power_save_enable=0;

 	;MOVX1 _power_save_enable ,#0
	BCLR _power_save_enable
.stabn 0x44,0,18,L16-_power_save
L16:
;Line#18 	sleep_delay_1=0;

 	;MOVU1 _sdata2 ,#0
	__SelectBANK _sdata2
	CLR _sdata2
.stabn 0x44,0,19,L17-_power_save
L17:
;Line#19 	sleep_delay_2=0;

 	;MOVU1 _sdata3 ,#0
	__SelectBANK _sdata3
	CLR _sdata3
.stabn 0xE0,0,1,L18-_power_save
L18:
.stabn 0x44,0,20,L19-_power_save
L19:
;Line#20   }

	JMP L5
L4:
.stabn 0xC0,0,1,L20-_power_save
L20:
.stabn 0x44,0,22,L21-_power_save
L21:
;Line#22   {

 .stabn 0x44,0,23,L22-_power_save
L22:
;Line#23     sleep_delay_1+=1;

 	;ADDU1 _sdata2 ,_sdata2 ,#1
	__SelectBANK _sdata2
	INCMS _sdata2
	NOP
.stabn 0x44,0,24,L23-_power_save
L23:
;Line#24     if(sleep_delay_1>249)

 	;LE L6 ,_sdata2 ,#249
	MOV A, _sdata2
	CMPRS A, #0xf9
	JLT L6
.stabn 0xC0,0,2,L24-_power_save
L24:
.stabn 0x44,0,25,L25-_power_save
L25:
;Line#25     {

 .stabn 0x44,0,26,L26-_power_save
L26:
;Line#26 	  sleep_delay_1=0;

 	;MOVU1 _sdata2 ,#0
	CLR _sdata2
.stabn 0x44,0,27,L27-_power_save
L27:
;Line#27 	  sleep_delay_2+=1;

 	;ADDU1 _sdata3 ,_sdata3 ,#1
	__SelectBANK _sdata3
	INCMS _sdata3
	NOP
.stabn 0x44,0,28,L28-_power_save
L28:
;Line#28 	  if(sleep_delay_2>9)

 	;LE L8 ,_sdata3 ,#9
	MOV A, _sdata3
	CMPRS A, #0x09
	JLT L8
.stabn 0xC0,0,3,L29-_power_save
L29:
.stabn 0x44,0,29,L30-_power_save
L30:
;Line#29 	  {

 .stabn 0x44,0,30,L31-_power_save
L31:
;Line#30 	    sleep_delay_2=0;

 	;MOVU1 _sdata3 ,#0
	CLR _sdata3
.stabn 0x44,0,31,L32-_power_save
L32:
;Line#31 	    FCPUM1=0;

 	;MOVX1 0xCA.4 ,#0
	B0BCLR 0xCA.4
.stabn 0x44,0,32,L33-_power_save
L33:
;Line#32 	    FCPUM0=1;         //进入睡眠模式

 	;MOVX1 0xCA.3 ,#1
	B0BSET 0xCA.3
.stabn 0xE0,0,3,L34-_power_save
L34:
.stabn 0x44,0,33,L35-_power_save
L35:
;Line#33 	  }

L8:
.stabn 0xE0,0,2,L36-_power_save
L36:
.stabn 0x44,0,34,L37-_power_save
L37:
;Line#34 	}  

L6:
.stabn 0xE0,0,1,L38-_power_save
L38:
.stabn 0x44,0,35,L39-_power_save
L39:
;Line#35   }

L5:
.stabs "sleep_delay_2:V9",40,0,0,_sdata3
.stabs "sleep_delay_1:V9",40,0,0,_sdata2
.stabn 0xE0,0,0,L40-_power_save
L40:
.stabn 0x44,0,36,L41-_power_save
L41:
;Line#36 }
L1:
	RET
...
Letext:
.stabs "power_save_enable:G300",32,0,0,_power_save_enable
