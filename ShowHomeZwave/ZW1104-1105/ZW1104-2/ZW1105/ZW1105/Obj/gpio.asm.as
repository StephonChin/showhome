...
.stabs "F:\ZW1104-1105\ZW1104-2\ZW1105\ZW1105/",0x64,0,3,Ltext0
.stabs ".\Src\gpio.c",0x64,0,3,Ltext0
Ltext0:
...
L2:
.stabn 0x44,0,17,L3-_gpio_init
L3:
 .stabn 0x44,0,18,L4-_gpio_init
L4:
	MOV A, #0x01
	B0MOV 0xB8, A
.stabn 0x44,0,19,L5-_gpio_init
L5:
	B0BCLR 0xD0.0
.stabn 0x44,0,21,L6-_gpio_init
L6:
	B0MOV 0xC1, A
.stabn 0x44,0,22,L7-_gpio_init
L7:
	MOV A, #0xf2
	B0MOV 0xE1, A
.stabn 0x44,0,23,L8-_gpio_init
L8:
	CLR (0xD1 &  0xFF)
.stabn 0x44,0,25,L9-_gpio_init
L9:
	MOV A, #0xff
	B0MOV 0xC2, A
.stabn 0x44,0,26,L10-_gpio_init
L10:
	CLR (0xD2 &  0xFF)
...
L12:
	B0BCLR 0xD5.4
.stabn 0x44,0,30,L13-_gpio_init
L13:
	MOV A, #0x0e
	B0MOV 0xC0, A
.stabn 0xE0,0,0,L14-_gpio_init
L14:
.stabn 0x44,0,31,L15-_gpio_init
L15:
L1:
	RET
