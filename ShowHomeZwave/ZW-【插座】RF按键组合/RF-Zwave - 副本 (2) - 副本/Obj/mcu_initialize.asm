...
;Line#20 	FP22 = 0;
 	...
 	;MOVX1 0xD2.2 ,#0
	B0BCLR 0xD2.2
.stabn 0x44,0,21,L11-_GpioInit
L11:
;Line#21 	FP23 = 1;	

 	;MOVX1 0xD2.3 ,#1
	B0BSET 0xD2.3
.stabn 0x44,0,22,L12-_GpioInit
L12:
;Line#22 	FP54 = 0;

 	;MOVX1 0xD5.4 ,#0
	B0BCLR 0xD5.4
.stabn 0xE0,0,0,L13-_GpioInit
L13:
...
L18:
;Line#30 	TC0M = 0x64;	//f = 1/64

 	;MOVU1 0xDA ,#100
	MOV A, #0x64
	B0MOV 0xDA, A
.stabn 0x44,0,31,L19-_TimerInit
L19:
;Line#31 	TC0C = 15;		//T = 15 * 64 = 1ms

 	;MOVU1 0xDB ,#15
	MOV A, #0x0f
	B0MOV 0xDB, A
.stabn 0x44,0,32,L20-_TimerInit
L20:
;Line#32 	TC0R = 15;

 	;MOVU1 0xCD ,#15
	B0MOV 0xCD, A
.stabn 0xE0,0,0,L21-_TimerInit
L21:
.stabn 0x44,0,33,L22-_TimerInit
L22:
;Line#33 }
L15:
	RET
