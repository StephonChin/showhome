...
.stabs ".\Src\mcu_initialize.c",0x64,0,3,Ltext0
Ltext0:
...
L3:
.stabn 0x44,0,12,L4-_GpioInit
L4:
;Line#12 {

 .stabn 0x44,0,13,L5-_GpioInit
L5:
;Line#13 	FP22M = 0;

 	;MOVX1 0xC2.2 ,#0
	B0BCLR 0xC2.2
.stabn 0x44,0,14,L6-_GpioInit
L6:
;Line#14 	FP54M = 0;

 	;MOVX1 0xC5.4 ,#0
	B0BCLR 0xC5.4
.stabn 0x44,0,16,L7-_GpioInit
L7:
;Line#16 	FP00M = 0;

 	;MOVX1 0xB8.0 ,#0
	B0BCLR 0xB8.0
.stabn 0x44,0,17,L8-_GpioInit
L8:
;Line#17 	FP10M = 1;

 	;MOVX1 0xC1.0 ,#1
	B0BSET 0xC1.0
.stabn 0x44,0,18,L9-_GpioInit
L9:
;Line#18 	P1OC  = 1;
	...
	MOV A, #0x01
	B0MOV 0xE9, A
.stabn 0x44,0,20,L10-_GpioInit
L10:
;Line#20 	FP10 = 1;

 	;MOVX1 0xD1.0 ,#1
	B0BSET 0xD1.0
.stabn 0xE0,0,0,L11-_GpioInit
L11:
...
_TimerInit:
.stabn 0xC0,0,0,L14-_TimerInit
L14:
.stabn 0x44,0,27,L15-_TimerInit
L15:
;Line#27 {

 .stabn 0x44,0,28,L16-_TimerInit
L16:
;Line#28 	TC0M = 0x64;	//f = 1/64

 	;MOVU1 0xDA ,#100
	MOV A, #0x64
	B0MOV 0xDA, A
.stabn 0x44,0,29,L17-_TimerInit
L17:
;Line#29 	TC0C = 16;		//T = 20 * 64 = 1ms

 	;MOVU1 0xDB ,#16
	MOV A, #0x10
	B0MOV 0xDB, A
.stabn 0x44,0,30,L18-_TimerInit
L18:
;Line#30 	TC0R = 16;

 	;MOVU1 0xCD ,#16
	B0MOV 0xCD, A
.stabn 0x44,0,32,L19-_TimerInit
L19:
;Line#32 	FGIE = 0;

 	;MOVX1 0xDF.7 ,#0
	B0BCLR 0xDF.7
.stabn 0x44,0,33,L20-_TimerInit
L20:
;Line#33 	FP00IRQ = 0;

 	;MOVX1 0xC8.0 ,#0
	B0BCLR 0xC8.0
.stabn 0x44,0,34,L21-_TimerInit
L21:
;Line#34 	FP00G1 = 0;

 	;MOVX1 0xBF.4 ,#0
	B0BCLR 0xBF.4
.stabn 0x44,0,35,L22-_TimerInit
L22:
;Line#35 	FP00G0 = 1;

 	;MOVX1 0xBF.3 ,#1
	B0BSET 0xBF.3
.stabn 0x44,0,36,L23-_TimerInit
L23:
;Line#36 	FP00IEN = 1;

 	;MOVX1 0xC9.0 ,#1
	B0BSET 0xC9.0
.stabn 0x44,0,37,L24-_TimerInit
L24:
;Line#37 	FGIE = 1;

 	;MOVX1 0xDF.7 ,#1
	B0BSET 0xDF.7
.stabn 0xE0,0,0,L25-_TimerInit
L25:
.stabn 0x44,0,38,L26-_TimerInit
L26:
;Line#38 }
L13:
	RET
