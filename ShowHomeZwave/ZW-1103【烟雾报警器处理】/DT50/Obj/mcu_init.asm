...
;Line#17   P1W=0x01;
	...
	MOV A, #0x01
	B0MOV 0xC0, A
.stabn 0x44,0,22,L9-_gpio_init
L9:
;Line#22   FP12 = 0;

 	;MOVX1 0xD1.2 ,#0
	B0BCLR 0xD1.2
.stabn 0x44,0,23,L10-_gpio_init
L10:
;Line#23   FP13 = 0;

 	;MOVX1 0xD1.3 ,#0
	B0BCLR 0xD1.3
.stabn 0x44,0,28,L11-_gpio_init
L11:
;Line#28   P5M=0xff;
	...
	MOV A, #0xff
	B0MOV 0xC5, A
.stabn 0x44,0,29,L12-_gpio_init
L12:
;Line#29   P5=0x10;
	...
	MOV A, #0x10
	B0MOV 0xD5, A
.stabn 0xE0,0,0,L13-_gpio_init
L13:
.stabn 0x44,0,30,L14-_gpio_init
L14:
;Line#30 }
...
_time_init:
.stabn 0xC0,0,0,L16-_time_init
L16:
.stabn 0x44,0,40,L17-_time_init
L17:
;Line#40 {

 .stabn 0x44,0,41,L18-_time_init
L18:
;Line#41   T0C=0x00;
	...
	__SelectBANKCNST 0
	CLR (0xD9 & 0xFF)
.stabn 0x44,0,42,L19-_time_init
L19:
;Line#42   T0M=0x01;     //RTC功能
	...
	MOV A, #0x01
	B0MOV 0xD8, A
.stabn 0x44,0,44,L20-_time_init
L20:
;Line#44   TC0R=190;     //(256-206)*2us=100us

 	;MOVU1 0xCD ,#190
	MOV A, #0xbe
	B0MOV 0xCD, A
.stabn 0x44,0,45,L21-_time_init
L21:
;Line#45   TC0C=190;

 	;MOVU1 0xDB ,#190
	B0MOV 0xDB, A
.stabn 0x44,0,46,L22-_time_init
L22:
;Line#46   TC0M=0xf4; 	//
	...
	MOV A, #0xf4
	B0MOV 0xDA, A
.stabn 0x44,0,48,L23-_time_init
L23:
;Line#48   FT0IEN=1;     //使能t0中断

 	;MOVX1 0xC9.4 ,#1
	B0BSET 0xC9.4
.stabn 0x44,0,49,L24-_time_init
L24:
;Line#49   FT0IRQ=0;

 	;MOVX1 0xC8.4 ,#0
	B0BCLR 0xC8.4
.stabn 0x44,0,50,L25-_time_init
L25:
;Line#50   FGIE=1;       //开放全局中断

 	;MOVX1 0xDF.7 ,#1
	B0BSET 0xDF.7
.stabn 0xE0,0,0,L26-_time_init
L26:
.stabn 0x44,0,51,L27-_time_init
L27:
;Line#51 }
L15:
	RET
