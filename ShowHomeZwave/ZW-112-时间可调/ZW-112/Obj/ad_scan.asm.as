...
_sdata2_initial_value:
	DB 0x0,0x0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
_SGV_INIT_CODE SEGMENT CODE BANK 0x0 INBANK
	extern code __INIT@global_
	B0MOV 132, #(_sdata2_initial_value)$M
	B0MOV 131, #(_sdata2_initial_value)$L
	MOV A, #(_sdata2)$M
	B0MOV H, A
	MOV A, #(_sdata2)$L
	B0MOV L, A
...
L53:
	...
	B0MOV L, A
	B0MOV 132, #(_AdScan_data@0)$M
	B0MOV 131, #(_AdScan_data@0)$L
	B0MOV 130, #0x00
	MOV A, #0x03
